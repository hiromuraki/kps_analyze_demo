...
```bash
# 开发机（预录视频）
uv run main.py --camera -1 --video-path ./sample_data/video_39.mp4

# 目标机（真实摄像头，摄像头序号需要视实际需要更改）
uv run main.py --analyzer default --camera 0 --width 640 --height 480 --fps 30
```
